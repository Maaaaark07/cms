    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.table}>
          ...
          {/* Table Rows */}
          <View style={styles.tableRow}>
            <Text style={[styles.tableCell, { width: '20%' }]}>Juan Dela Cruz</Text>
            <Text style={[styles.tableCell, { width: '20%' }]}>30</Text>
            <Text style={[styles.tableCell, { width: '20%' }]}>Barangay 123</Text>
            <Text style={[styles.tableCell, { width: '20%' }]}>Employment</Text>
            <Text style={[styles.tableCell, { width: '20%' }]}>Scholarship</Text>
          </View>
        </View>
      </View>
