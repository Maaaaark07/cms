    ...
    return (
        <div className="p-4 bg-white rounded-md">
            ...
            {blotterData
                ...
                .slice(0, 5)
                .map((incident) => (
                    <div key={incident.blotter_id} className='flex items-center bg-blue-50 rounded-md p-4 justify-between mb-4'>
                        <div className='flex items-center gap-4'>
                            ...
                            <div className='leading-3 flex flex-col'>
                                <span className='text-sm font-bold text-gray-500'>{capitalizeFirstLetter(incident.incident_type)}</span>
                                <span className='text-sm text-gray-500'>Incident Report ID: <span className='text-blue-500'>#{incident.blotter_id}</span></span>
                                <span className='text-sm text-gray-500'>Complainant: <span className='text-blue-500'>{incident.complainant}</span></span>
                            </div>
                        </div>
