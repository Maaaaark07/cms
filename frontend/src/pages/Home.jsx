...
const Home = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/blotter', { withCredentials: true })
                        ...
                        {loading ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                                <div className="p-4 bg-white rounded-md">
                                    <h3 className="text-gray-500 text-xl font-bold mb-4">Population Statistics</h3>
                                    <div className="relative flex items-center justify-center" style={{ height: '484px' }}>
